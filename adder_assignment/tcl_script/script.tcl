...
#add design sources
add_files -fileset sources_1 {./top.v  adder.v full_adder.v half_adder.v segconv.v segctrl.v tbSegctrl.v display.v   }
...
add_files -fileset constrs_1 ./pins.xdc
...
open_hw_target
set_property PROGRAM.FILE {/home/audrey/Documents/Verilog_course/adder_assignment/tcl_script/project1/project1.runs/impl_1/display.bit} [get_hw_devices xc7s50_0]
